...
//    }
    ...
    public void setDisabledTimes(ArrayList<Timepoint> disabledTimes) {
        mDefaultLimiter.setDisabledTimes(disabledTimes);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedColor = ContextCompat.getColor(context, R.color.selected_title);
        mUnselectedColor = ContextCompat.getColor(context, R.color.unselected_title);
        mAmPmSelectedColor = ContextCompat.getColor(context, R.color.selected_am_pm);
        mAmPmUnSelectedColor = ContextCompat.getColor(context, R.color.unselected_am_pm);
        mHourView = view.findViewById(R.id.mdtp_hours);
        mHourView.setOnKeyListener(keyboardListener);
        mMinStr = view.findViewById(R.id.min_str);
...
//        mCancelButton.setVisibility(isCancelable() ? View.VISIBLE : View.GONE);
        ...
        view.findViewById(R.id.mdtp_time_picker_dialog).setBackgroundColor(backgroundColor);
        return view;
    }
...
//        if(mVibrate) mHapticFeedbackController.tryVibrate();
    ...
    private void updateAmPmDisplay(int amOrPm) {
        if (mVersion == Version.VERSION_2) {
            if (amOrPm == AM) {
                mAmTextView.setTextColor(mAmPmSelectedColor);
                mPmTextView.setTextColor(mAmPmUnSelectedColor);
                Utils.tryAccessibilityAnnounce(mTimePicker, mAmText);
            } else {
                mAmTextView.setTextColor(mAmPmUnSelectedColor);
                mPmTextView.setTextColor(mAmPmSelectedColor);
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle, boolean delayLabelAnimate,
        ...
        mMinStr.setTextColor(hourColor);
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            mMinStr.setTextColor(mUnselectedColor);
            if (!mIs24HourMode) {

...
import kotlinx.android.synthetic.main.adapter_product_list_item.view.*
...
class ProductListAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
            ProductHolder(LayoutInflater.from(parent.context).inflate(R.layout.adapter_product_list_item, parent, false))

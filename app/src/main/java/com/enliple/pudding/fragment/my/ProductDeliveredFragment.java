...
public class ProductDeliveredFragment extends AbsBaseFragment implements DeliveryStatusAdapter.Listener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setLayout(v);
        Logger.e("ProductDeliveredFragment onCreateView");
        return v;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Logger.e("ProductDeliveredFragment onViewCreated");
        mRecyclerView.setItemViewCacheSize(RECYCLER_VIEW_ITEM_CACHE_SIZE);
        mRecyclerView.setHasFixedSize(false);
        layoutManager = new LinearLayoutManager(getActivity());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        mRecyclerView.setLayoutManager(layoutManager);
        setEmptyText(getString(R.string.msg_my_shopping_delivery_status_delivered_not_founds),
                getString(R.string.msg_my_shopping_delivery_status_delivered));
...
//        loadData();
    ...
    public void onResume() {
        super.onResume();
        loadData();
        Logger.e("ProductDeliveredFragment onResume");
    }

    @Override
    public void onPause() {
        super.onPause();
        Logger.e("ProductDeliveredFragment onPause");
    }

    @Override
    public void onItemClicked(int position) {
        Intent intent = new Intent(getActivity(), DeliveryStatusDetailActivity.class);
        intent.putExtra(DeliveryStatusDetailActivity.INTENT_EXTRA_KEY_STATUS_TYPE, "배송완료");
    ...
    public void onDeliveryStatusClicked(DeliveryStatusProductData data) {
        DeliveryBasicInfoDialog deliveryBasicInfoDialog = new DeliveryBasicInfoDialog(getActivity(),
                "배송조회", data.trackingInfo_name, data.trackingInfo_code, data.trackingInfo_url);
...
//        startActivity(intent);
    ...
    private void loadData() {
        ...
        task.getDeliveryStatusList("배송완료",
                (result, obj) -> {
                        ...
                        if (responseObj != null && responseObj.getResult().equals("SUCCESS")) {
                            if (responseObj.deliveryType != null) {
                                if (DeliveryStatusActivity.instance != null) {
                                    DeliveryStatusActivity.instance.setProductDeliveredCnt(responseObj.deliveryType.productDelivered);
                                }
                                ...
                                DeliveryStatusActivity.instance.setProductDeliveredCnt(0);

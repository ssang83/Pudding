...
public class ProductDeliveringFragment extends AbsBaseFragment implements DeliveryStatusAdapter.Listener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setEmptyText(getString(R.string.msg_my_shopping_delivery_status_delivering_not_founds),
    ...
    public void onItemClicked(int position) {
        ...
        intent.putExtra(DeliveryStatusDetailActivity.INTENT_EXTRA_KEY_STATUS_TYPE, "배송중");
...
//        startActivity(intent);
    ...
    private void loadData() {
        ...
        task.getDeliveryStatusList("배송중",
                (result, obj) -> {
                        ...
                        if (responseObj != null && responseObj.getResult().equals("SUCCESS")) {
                            if (responseObj.deliveryType != null) {
                                if (DeliveryStatusActivity.instance != null) {
                                    DeliveryStatusActivity.instance.setProductDeliveringCount(responseObj.deliveryType.productDeliverying);
                                }
                                ...
                                DeliveryStatusActivity.instance.setProductDeliveringCount(0);
                                setEmptyViewVisibility(true);
                            }
                        } else {
                            DeliveryStatusActivity.instance.setProductDeliveringCount(0);

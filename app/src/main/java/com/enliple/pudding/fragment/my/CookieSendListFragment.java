...
import com.enliple.pudding.adapter.my.CookieSendListAdapter;
...
public class CookieSendListFragment extends Fragment {
    ...
    private CookieSendListAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_cookie_send_list, container, false);
        Logger.e("CookieSendListFragment onCreateView");
        currentPosition = -1;
        ...
        adapter = new CookieSendListAdapter(getActivity());
...
//        recyclerView.setAdapter(adapter);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Logger.e("CookieSendListFragment onViewCreated");
    }

    private void setSelect(int position) {
        Logger.e("currentPosition 1111 :: " + currentPosition);
...
//                ArrayList<CookieSendListModel> modelArray = new ArrayList<>();
//                for ( int i = 0 ; i < array.length() ; i ++ ) {
//                    JSONObject subObj = array.getJSONObject(i);
//                    CookieSendListModel model = new CookieSendListModel();
//                    if ( subObj != null ) {
//                        model.setDate(subObj.optString("date"));
//                        model.setBjName(subObj.optString("bj_name"));

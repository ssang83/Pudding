...
import com.enliple.pudding.adapter.home.TripAdapter;
...
public class PuddingTravelFragment extends Fragment implements TripAdapter.Listener {
    private LinearLayoutManager layoutManager;
    private RecyclerView itemRecyclerView;
    private ProgressBar progressBar;
    private AppCompatImageView topBtn;
    private TripAdapter itemAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        itemAdapter = new TripAdapter(getActivity());
        itemRecyclerView.setAdapter(itemAdapter);
        itemAdapter.setListener(PuddingTravelFragment.this);
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (mIsVisibleToUser) {
            if (!mIsFirst) {
                ...
                mIsFirst = true;
                EventBus.getDefault().post(new NetworkBus(NetworkApi.API81.name(), "select_union", "", "travel"));
            }
        }
    }
    ...
    public void onMessageEvent(NetworkBusResponse data) {
        ...
        String API81 = NetworkHandler.Companion.getInstance(getActivity()).getKey(NetworkApi.API81.toString(), "select_union", "", "travel");
        API114 response = null;
        if (data.arg1.startsWith("GET/mui/main/travel?page=")) {
            if  (progressBar != null )
            ...
            EventBus.getDefault().post(new NetworkBus(NetworkApi.API114.name(), "travel", mCount + "", selectedCategory, order));
        }
    }
    ...
    private BroadcastReceiver receiver = new  BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ( action == "likeChange") {
                ...
                if ( gubun == "run") {
                    if ( page == PuddingHomeTabFragment.PAGE_TRAVEL && itemAdapter != null ) {
                    ...
                    if (itemAdapter != null ) {
                        if ( page == PuddingHomeTabFragment.PAGE_TRAVEL ) {
                            itemAdapter.runTimer();
                        } else {
                            itemAdapter.cancelTimer();
                        }

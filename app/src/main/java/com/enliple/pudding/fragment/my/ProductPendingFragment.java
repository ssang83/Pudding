...
public class ProductPendingFragment extends AbsBaseFragment implements DeliveryStatusAdapter.Listener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setEmptyText(getString(R.string.msg_my_shopping_delivery_status_pending_not_founds),
    ...
    public void onItemClicked(int position) {
        ...
        intent.putExtra(DeliveryStatusDetailActivity.INTENT_EXTRA_KEY_STATUS_TYPE, "상품준비중");
    ...
    public void onCancelPurchaseClicked(DeliveryStatusProductData data) {
        ...
        intent.putExtra(CRERequestDetailActivity.INTENT_KEY_PRODUCT_PRICE, data.price);
    ...
    private void loadData() {
        ...
        task.getDeliveryStatusList("상품준비중",
                (result, obj) -> {
                        ...
                        if (responseObj != null && responseObj.getResult().equals("SUCCESS")) {
                            if (responseObj.deliveryType != null) {
                                if (DeliveryStatusActivity.instance != null) {
                                    DeliveryStatusActivity.instance.setProductPendingCount(responseObj.deliveryType.productPending);
                                }
                                ...
                                DeliveryStatusActivity.instance.setProductPendingCount(0);
                                setEmptyViewVisibility(true);
                            }
                        } else {
                            DeliveryStatusActivity.instance.setProductPendingCount(0);

 ...
 */
class SharingVODFragment : AbsBaseFragment(), ShareContentAdapter.Listener {

    companion object {
        private const val TAG = "SharingVODFragment"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_sharing_vod, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mAdapter.setListener(this@SharingVODFragment)
    ...
    fun onMessageEvent(data: NetworkBusResponse) {
        val API106 = NetworkHandler.getInstance(context!!)
                .getKey(NetworkApi.API106.toString(), AppPreferences.getUserId(context!!)!!, "")

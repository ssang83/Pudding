...
import kotlinx.android.synthetic.main.activity_share_vod.*
 ...
 */
class ShareVODActivity : AppCompatActivity(), ShareContentAdapter.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_share_vod)
    ...
    fun onMessageEvent(data: NetworkBusResponse) {
        val API105 = NetworkHandler.getInstance(this)
                .getKey(NetworkApi.API105.toString(), AppPreferences.getUserId(this)!!, "")

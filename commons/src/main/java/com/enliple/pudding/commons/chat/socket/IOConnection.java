...
class IOConnection implements IOCallback {
    ...
    private static SSLSocketFactory sslSocketFactory = HttpsURLConnection.getDefaultSSLSocketFactory();
        ...
        try {
            ...
            HttpsURLConnection.setDefaultHostnameVerifier(new HostnameVerifier() {
                ...
                public boolean verify(String hostname, SSLSession session) {
                    Logger.d("Accepted host " + hostname + " during SSL Handshaking");
                    return true;
                }
            });
            ...
            Logger.i("handshake response: " + response);
            sessionId = data[0];
        ...
        if (transport.canSendBulk()) {
            ...
            try {
                ...
                for (String text : texts) {
                    Logger.i("transportConnected > " + text);
                }
                Logger.i("Bulk end");
                // DEBUG END
                transport.sendBulk(texts);
            } catch (IOException e) {
                Logger.w("transport.canSendBulk: " + e.getMessage());
    ...
    public void transportDisconnected() {
        Logger.i("transportDisconnected");
    ...
    public void transportMessage(String text) {
        //Logger.i("transportMessage < " + text);
        IOMessage message;
        try {
        ...
        switch (message.getType()) {
            ...
            case IOMessage.TYPE_JSON_MESSAGE:
                try {
                    ...
                    Logger.w("Malformated JSON received");
                }
                break;
            case IOMessage.TYPE_EVENT:
                try {
                    ...
                    Logger.w("Malformated JSON received: " + e.getMessage());
                }
                break;
            ...
            case IOMessage.TYPE_ACK:
                ...
                if (data.length == 2) {
                    try {
                        ...
                        if (ack == null)
                            Logger.w("Received unknown ack packet");
                        else {
                        ...
                        Logger.w("Received malformated Acknowledge! This is potentially filling up the acknowledges!");
                    } catch (JSONException e) {
                        Logger.w("Received malformated Acknowledge data!");
                    }
            ...
            case IOMessage.TYPE_NOOP:
                break;
            default:
                Logger.w("Unkown type received" + message.getType());
                break;
        }
    }
